...
# Necessario apra o octave 4
sudo apt-cache search "octave"

# Instalação principal
sudo apt-get install atom build-essential cmake curl epstool ipython3-notebook g++ gcc \
geany gems geogebra gfortran git make nodejs octave pstoedit python3-matplotlib \
python3-pip  python3-yaml python-dev python-pip python-setuptools \
r-base ruby2.2 ruby2.2-dev ssh subversion texlive-latex-extra transfig unrar vim -y
